...
ranges = [0.28, 1.39, 3.33, 5.28, 7.78, 10.56, 13.89, 16.95]                # Comparison Meteoblue
...
df_ranges_a = pd.DataFrame(ranges_a, index=months, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])
df_ranges_c = pd.DataFrame(ranges_c, index=months, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])
...
df_dir_a = pd.DataFrame(dir_a, index=directions, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])   # Creating a df from the arrays obtained
df_dir_c = pd.DataFrame(dir_c, index=directions, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])
df_dir_a = pd.melt(df_dir_a.reset_index(), id_vars=['index'], var_name='SpeedRange [km/h]', value_name='Frequency')   # Changes df type from "wide" to "long"
df_dir_c = pd.melt(df_dir_c.reset_index(), id_vars=['index'], var_name='SpeedRange [km/h]', value_name='Frequency')
...
df_dir2_a = pd.DataFrame(dir2_a, index=directions2, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])
df_dir2_c = pd.DataFrame(dir2_c, index=directions2, columns=["<1","1-5","5-12","12-19","19-28","28-38","38-50","50-61",">61"])
df_dir2_a = pd.melt(df_dir2_a.reset_index(), id_vars=['index'], var_name='SpeedRange [km/h]', value_name='Frequency')    
...
fig01= px.bar(df_ranges_a, x=df_ranges_a.index, y=[">61", "50-61", "38-50", "28-38", "19-28", "12-19", "5-12", "1-5", "<1"], title='Monthly winds in Munich airport', labels={'index':'Month','value':'Frequency'}, color_discrete_sequence= px.colors.sequential.Oranges_r)
fig01.write_html("RelevantGraphs/CompMeteoblue/MonthWinds_airp.html")
# fig01.write_image("Relevant raphs/01_MonthWinds_airp.svg")
fig01.write_image("RelevantGraphs/CompMeteoblue/MonthWinds_airp.png")

# MONTHLY WINDS (city)
fig02 = px.bar(df_ranges_c, x=df_ranges_c.index, y=[">61", "50-61", "38-50", "28-38", "19-28", "12-19", "5-12", "1-5", "<1"], title='Monthly winds in Munich city', labels={'index':'Month','value':'Frequency'}, color_discrete_sequence= px.colors.sequential.Oranges_r)
fig02.update_yaxes(range=[0,31])
fig02.write_html("RelevantGraphs/CompMeteoblue/MonthWinds_city.html")
fig02.write_image("RelevantGraphs/CompMeteoblue/MonthWinds_city.png")
fig02.write_image("RelevantGraphs/CompMeteoblue/MonthWinds_city.svg")

# WINDROSE (airport)
fig03 = px.bar_polar(df_dir_a, r="Frequency", theta="Direction", color="SpeedRange [km/h]", title='Wind direction and intensity in Munich airport', template="plotly_white", color_discrete_sequence= px.colors.sequential.Plasma_r)
fig03.write_html("RelevantGraphs/CompMeteoblue/WindRose_airp.html")
fig03.write_image("RelevantGraphs/CompMeteoblue/WindRose_airp.png")

# WINDROSE (city)
fig04 = px.bar_polar(df_dir_c, r="Frequency", theta="Direction", color="SpeedRange [km/h]", title='Wind direction and intensity in Munich city', template="plotly_white", color_discrete_sequence= px.colors.sequential.Plasma_r)
fig04.write_html("RelevantGraphs/CompMeteoblue/WindRose_city.html")
fig04.write_image("RelevantGraphs/CompMeteoblue/WindRose_city.png")

# PRECISE WINDROSE (airport)
fig05 = px.bar_polar(df_dir2_a, r="Frequency", theta="Direction", color="SpeedRange [km/h]", title='Wind direction and intensity in Munich airport', template="plotly_white", color_discrete_sequence= px.colors.sequential.Plasma_r)
fig05.write_html("RelevantGraphs/CompMeteoblue/WindRose_precise_airp.html")
fig05.write_image("RelevantGraphs/CompMeteoblue/WindRose_precise_airp.png")

# PRECISE WINDROSE (city)
fig06 = px.bar_polar(df_dir2_c, r="Frequency", theta="Direction", color="SpeedRange [km/h]", title='Wind direction and intensity in Munich city', template="plotly_white", color_discrete_sequence= px.colors.sequential.Plasma_r)
fig06.write_html("RelevantGraphs/CompMeteoblue/WindRose_precise_city.html")
fig06.write_image("RelevantGraphs/CompMeteoblue/WindRose_precise_city.png")
fig06.write_image("RelevantGraphs/CompMeteoblue/WindRose_precise_city.svg")
'''
...
fig7.write_html("RelevantGraphs/07_GustvsMean_airp.html")
fig7.write_image("RelevantGraphs/07_GustvsMean_airp.png")
...
fig8.write_html("RelevantGraphs/08_GustvsMean_city.html")
fig8.write_image("RelevantGraphs/08_GustvsMean_city.png")
...
fig9.write_html('RelevantGraphs/09_Histogram_airp.html')
fig9.write_image("RelevantGraphs/09_Histogram_airp.png")
...
fig10.write_html('RelevantGraphs/10_Histogram_city.html')
fig10.write_image("RelevantGraphs/10_Histogram_city.png")
...
fig11.write_html('RelevantGraphs/11_Histogram_gust_airp.html')
fig11.write_image("RelevantGraphs/11_Histogram_gust_airp.png")
...
fig12.write_html('RelevantGraphs/12_Histogram_gust_city.html')
fig12.write_image("RelevantGraphs/12_Histogram_gust_city.png")
'''